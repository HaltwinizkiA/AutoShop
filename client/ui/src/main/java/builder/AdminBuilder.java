...
import action.Exit;
import action.box.FreeUpSpaceBox;
import action.box.ModifyBoxCapacity;
import action.box.ViewFreeBox;
import action.csv.*;
import action.master.*;
import action.order.*;
import action.work.AddWork;
import action.work.DellWork;
import action.work.ViewWorkList;
import api.Build;
import menu.Menu;
...
public class AdminBuilder implements Build, Serializable {
    ...
    public void buildMainMenu() {
        ...
        orderMenuItems.add(new MenuItem("Exit", new Exit(), null));
        ...
        workMenuItems.add(new MenuItem("Exit", new Exit(), null));
        ...
        sortMasterMenuItems.add(new MenuItem("Exit", new Exit(), null));
        ...
        masterMenuItems.add(new MenuItem("View Master In Order", new ViewAllMasters(), masterMenu));
        masterMenuItems.add(new MenuItem("EXIT", new Exit(), null));
        ...
        csvMenuItems.add(new MenuItem("EXIT", new Exit(), null));
